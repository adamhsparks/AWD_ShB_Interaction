---
title: "AWD Sheath Blight Data Import and Processing"
...
output:
  html_document:
    ...
    theme: yeti
vignette: >
  %\VignetteIndexEntry{AWD_Sheath_Blight_Data_Processing}
...
The raw data are located in the `data` folder of the installed _rice.awd.pests_ 
...
TShB_inc_15 <-
  ...
  summarise(AUDPC = audpc(PLOT_TShB_incidence, DAYS),
...
AUDPC_S <- separate(data = AUDPS, col = TRT,
                         sep = "_",
                         into = c("WMGT", "NRTE"))
AUDPC_S <- mutate_at(.tbl = AUDPS,
                              .funs = factor,
                              .vars = c("WMGT", "NRTE"))
