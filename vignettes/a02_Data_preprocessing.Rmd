...
# Add YEAR/REP/TRT/ASMT cols to AUDPS values via TShB_inc_15 df
ShB_15 <- left_join(TShB_inc_15, AUDPS_15, by = "PLOT") %>% 
  ungroup() %>% 
  rename(TShB_inc_AUDPS = TShB_inc_15_AUDPS,
...
# Add YEAR/REP/TRT/ASMT cols to AUDPS values via TShB_inc_16 df
ShB_16 <- left_join(TShB_inc_16, AUDPS_16, by = "PLOT") %>% 
  ungroup() %>% 
  rename(TShB_inc_AUDPS = TShB_inc_16_AUDPS,
