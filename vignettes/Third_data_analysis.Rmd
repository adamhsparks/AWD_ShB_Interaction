...
The tiller analyses doe not include an interaction prior while the leaf
...
In 2015 both the N100 and N120 rates were significantly different than the N0 treatment. The AWD water management was not significantly different from the control FLD treatment. In the leaf phase of the disease neither N by WMGT interaction was significant.

In 2016 the neither of the treatments, nitrogen rate or water management, were significantly different from the base treatments for leaf sheath blight severity. The N180 by AWD interaction was significantly different from the N60 by FLD water management.
