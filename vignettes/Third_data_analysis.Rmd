...
The last step is to create a `data.frame` of model information for the paper. 

```{r mcmc_table, message=FALSE}

tables_list <-
  list(
    `2015 Tiller Incidence` = m1,
    `2015 Tiller Severity` = m2,
    `2015 Leaf Severity` = m3,
    `2016 Tiller Incidence` = m4,
    `2016 Tiller Severity` = m5,
    `2016 Leaf Severity` = m6
  )

pub_table <- vector("list", 6)
