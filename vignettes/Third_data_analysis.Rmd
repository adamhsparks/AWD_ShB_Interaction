...
```{r create_analysis_df, cache=TRUE}
...
```{r 2015_TShB_incidence, cache=TRUE}
...
```{r 2015_TShB_severity, cache=TRUE}
eprior <- list(R = list(V = 1, nu = 0.02),
               G = list(G1 = list(V = 1, nu = 0.02, alpha.V = 1000)))
...
```{r 2015_LShB_severity, cache=TRUE}
eprior <- list(R = list(V = 1, nu = 0.02),
               G = list(G1 = list(V = 1, nu = 0.02, alpha.V = 1000)))
...
```{r 2016_TShB_incidence, cache=TRUE}
...
```{r 2016_TShB_severity, cache=TRUE}
eprior <- list(R = list(V = 1, nu = 0.02),
               G = list(G1 = list(V = 1, nu = 0.02, alpha.V = 1000)))
...
```{r 2016_LShB_severity, cache=TRUE}
eprior <- list(R = list(V = 1, nu = 0.02),
               G = list(G1 = list(V = 1, nu = 0.02, alpha.V = 1000)))
