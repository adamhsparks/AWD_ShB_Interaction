...
```{r 2015_TShB_incidence, cache=FALSE, message=TRUE, warning=TRUE}
...
```{r 2015_LShB_severity, cache=FALSE, message=TRUE, warning=TRUE}
m3_priors <- prior_string("normal(1, 3)", class = "b")
...
```{r 2016_TShB_incidence, cache=FALSE, message=TRUE, warning=TRUE}
m4_priors <- prior_string("normal(0, 2)", class = "b")
...
```{r 2016_TShB_severity, cache=FALSE, message=TRUE, warning=TRUE}
...
```{r 2016_LShB_severity, cache=FALSE, message=TRUE, warning=TRUE}
m6_priors <- prior_string("normal(0, 2)", class = "b")
