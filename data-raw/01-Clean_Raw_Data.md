...
`load(system.file("extdata", "DS2016_Raw_1.csv", package = "rice.awd.pests"))` `load(system.file("extdata", "DS2016_Raw_2.csv", package = "rice.awd.pests"))` `load(system.file("extdata", "DS2016_Raw_3.csv", package = "rice.awd.pests"))` `load(system.file("extdata", "DS2016_Raw_4.csv", package = "rice.awd.pests"))`
...
save(AUDPS, file = "../data/AWD_AUDPS.rda", compress = "bzip2")
```
