...
```{r 2015_TShB_incidence_exp, results='hide', message=FALSE, warning=FALSE}
...
```{r 2015_TShB_percent_exp, results='hide', message=FALSE, warning=FALSE}
...
```{r 2015_LShB_percent_exp, results='hide', message=FALSE, warning=FALSE}
