...
f1 <- fitdist(AUDPS15$TShB_incidence, "norm")
plot(f1)
car::qqp(AUDPS15$TShB_incidence, "norm")

f2 <- fitdist(AUDPS15$TShB_incidence, "exp")
plot(f2)
car::qqp(AUDPS15$TShB_incidence, "exp")
...
f1 <- fitdist(AUDPS156$TShB_incidence, "norm")
plot(f1)
car::qqp(AUDPS156$TShB_incidence, "norm")

f2 <- fitdist(AUDPS156$TShB_incidence, "exp")
plot(f2)
car::qqp(AUDPS156$TShB_incidence, "exp")
