...
```{r 2015_TShB_inc_exp, results='hide', message=FALSE, warning=FALSE}
...
```{r 2015_TShB_sev_norm, results='hide', message=FALSE, warning=FALSE}
AUDPS15 <- subset(AUDPS, YEAR == "2015")
...
```{r 2015_TShB_sev_exp, results='hide', message=FALSE, warning=FALSE}
...
```{r 2015_LShB_sev_norm, results='hide', message=FALSE, warning=FALSE}
AUDPS15 <- subset(AUDPS, YEAR == "2015")
...
```{r 2016_TShB_sev_norm, results='hide', message=FALSE, warning=FALSE}
AUDPS16 <- subset(AUDPS, YEAR == "2016")
...
```{r 2016_TShB_sev_exp, results='hide', message=FALSE, warning=FALSE}
...
```{r 2016_LShB_sev_norm, results='hide', message=FALSE, warning=FALSE}
AUDPS16 <- subset(AUDPS, YEAR == "2016")
...
```{r 2016_LShB_sev_exp, results='hide', message=FALSE, warning=FALSE}
