...
### Normal
```{r norm, results='hide', message=FALSE, warning=FALSE}
...
```{r exp, results='hide', message=FALSE, warning=FALSE}
AUDPS15 <- subset(AUDPS, YEAR == "2015")
...
Until the issue with more diseased tillers than tillers in a hill is addressed,
this section will not work completely and properly.
