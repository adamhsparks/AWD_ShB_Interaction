...
![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2015_Tiller_Inc-1.png)

``` r
qqp(AUDPS_15$TShB_inc_AUDPS, "lnorm")
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2015_Tiller_Inc-2.png)

``` r
qqp(AUDPS_15$TShB_inc_AUDPS, "exp")
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2015_Tiller_Inc-3.png)

``` r
qqp(AUDPS_15$TShB_inc_AUDPS, "chisq", df = 2)
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2015_Tiller_Inc-4.png)
...
![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2015_Tiller_Sev-1.png)

``` r
qqp(AUDPS_15$TShB_percent_AUDPS, "lnorm")
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2015_Tiller_Sev-2.png)

``` r
qqp(AUDPS_15$TShB_percent_AUDPS, "exp")
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2015_Tiller_Sev-3.png)

``` r
qqp(AUDPS_15$TShB_percent_AUDPS, "chisq", df = 2)
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2015_Tiller_Sev-4.png)
...
![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2015_Leaf_Sev-1.png)

``` r
qqp(AUDPS_15$LShB_percent_AUDPS, "lnorm")
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2015_Leaf_Sev-2.png)

``` r
qqp(AUDPS_15$LShB_percent_AUDPS, "exp")
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2015_Leaf_Sev-3.png)

``` r
qqp(AUDPS_15$LShB_percent_AUDPS, "chisq", df = 2)
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2015_Leaf_Sev-4.png)
...
![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2016_Tiller_Inc-1.png)

``` r
qqp(AUDPS_16$TShB_inc_AUDPS, "lnorm")
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2016_Tiller_Inc-2.png)

``` r
qqp(AUDPS_16$TShB_inc_AUDPS, "exp")
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2016_Tiller_Inc-3.png)

``` r
qqp(AUDPS_16$TShB_inc_AUDPS, "chisq", df = 2)
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2016_Tiller_Inc-4.png)
...
![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2016_Tiller_Sev-1.png)

``` r
qqp(AUDPS_16$TShB_percent_AUDPS, "lnorm")
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2016_Tiller_Sev-2.png)

``` r
qqp(AUDPS_16$TShB_percent_AUDPS, "exp")
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2016_Tiller_Sev-3.png)

``` r
qqp(AUDPS_16$TShB_percent_AUDPS, "chisq", df = 2)
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2016_Tiller_Sev-4.png)
...
![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2016_Leaf_Sev-1.png)

``` r
qqp(AUDPS_16$LShB_percent_AUDPS, "lnorm")
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2016_Leaf_Sev-2.png)

``` r
qqp(AUDPS_16$LShB_percent_AUDPS, "exp")
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2016_Leaf_Sev-3.png)

``` r
qqp(AUDPS_16$LShB_percent_AUDPS, "chisq", df = 2)
```

![](Test_Residuals_for_Model_Fits_files/figure-markdown_github-ascii_identifiers/2016_Leaf_Sev-4.png)

Based on these graphs, few of the data are a good fit for a normal distribution, which suggests that using an analysis that does need these assumptions to be met, *e.g.* a Bayesian analysis method. The *MCMCglmm* package provides an easy way to implement this type of analysis.

These analyses can be found in the [02\_MCMC\_glmm\_analysis.md](02_MCMC_glmm_analysis.md) file.
